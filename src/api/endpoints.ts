...
export const FETCH_HOUSE_OPTIONS = (id: string) =>
  `${INTERNAL_API_URL}/houses/${id}/reservations/options`
...
export const PUT_RESERVATION_PRICE = (id: number) =>
  `/houses/${id}/reservations/price/`
export const POST_MAKE_RESERVATION = (id: number) =>
  `/houses/${id}/reservations/`
export const GET_HOUSE_RESERVATION = (slug: string) =>
  `/houses/reservations/by_slug/?slug=${slug}`
